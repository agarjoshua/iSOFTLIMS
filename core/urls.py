...
urlpatterns = [
    ...
    path(
        ...
        AdminViews.admin_profile_update,
    ...
    path(
        "admissions_approve/", AdminViews.admissions_approve, name="admissions_approve"
    ),
    path("dvc_approve/", AdminViews.dvc_approve, name="dvc_approve"),
    # DEPARTMENT MANAGEMENT URLS
    path(
        "manage_department/", AdminViews.manage_departments, name="manage_departments"
    ),
    path("add_department/", AdminViews.add_department, name="add_department"),
    path(
        "add_department_save/",
        AdminViews.add_department_save,
        name="add_department_save",
    ),
    path(
        "edit_department/<department_id>/",
        AdminViews.edit_department,
        name="edit_department",
    ),
    path(
        "edit_department_save/",
        AdminViews.edit_department_save,
        name="edit_department_save",
    ),
    path(
        "delete_department/<department_id>/",
        AdminViews.delete_department,
    ...
    path(
        "delete_teacher/<teacher_id>/", AdminViews.delete_teacher, name="delete_teacher"
    ),
    ...
    path(
        "enroll_session_save/<enrollment_id>",
        StudentViews.enroll_session_save,
        name="enroll_session_save",
    ),
    path("student_classes/", StudentViews.enroll_classes, name="enroll_classes"),
    path(
        "enroll_class_save/", StudentViews.enroll_class_save, name="enroll_class_save"
    ),
    # path('student_classes/', StudentViews.enroll_classes, name="enroll_classes"),
    ...
    path(
        "delete_student/<student_id>/", AdminViews.delete_student, name="delete_student"
    ),
    path(
        "student_session_management/",
        StudentViews.students_sessions_management,
        name="students_sessions_management",
    ),
    ...
    path(
        "student_affairs/",
        StudentAdminAffairs.student_affairs_home,
        name="student_affairs",
    ),
    path(
        "manage_student_approvals/",
        StudentAdminAffairs.manage_student_approvals,
        name="manage_student_approvals",
    ),
    path(
        "confirm_defer_student/",
        StudentAdminAffairs.confirm_defer_student,
        name="confirm_defer_student",
    ),
    path(
        "deny_defer_student/",
        StudentAdminAffairs.deny_defer_student,
        name="deny_defer_student",
    ),
    path(
        "manage_temporary_approvals/",
        StudentAdminAffairs.manage_temporary_approvals,
        name="manage_temporary_approvals",
    ),
    path(
        "confirm_temporary_defer/",
        StudentAdminAffairs.confirm_temporary_defer,
        name="confirm_temporary_defer",
    ),
    path(
        "deny_temporary_defer/",
        StudentAdminAffairs.deny_temporary_defer,
        name="deny_temporary_defer",
    ),
    path(
        "manage_interfaculty_transfer/",
        StudentAdminAffairs.manage_interfaculty_transfer,
        name="manage_interfaculty_transfer",
    ),
    path(
        "confirm_interfaculty_transfer/",
        StudentAdminAffairs.confirm_interfaculty_transfer,
        name="confirm_interfaculty_transfer",
    ),
    path(
        "deny_interfaculty_transfer/",
        StudentAdminAffairs.deny_interfaculty_transfer,
        name="deny_interfaculty_transfer",
    ),
    ...
    path(
        "edit_guardian/<guardian_id>/", AdminViews.edit_guardian, name="edit_guardian"
    ),
    path(
        "edit_guardian_save/", AdminViews.edit_guardian_save, name="edit_guardian_save"
    ),
    path(
    ...
    path(
        "check_if_course_exists/",
        AdminViews.check_if_course_exists,
        name="check_if_course_exists",
    ),
    ...
    path(
        ...
        AdminViews.check_username_exist,
        name="check_username_exist",
    ),
    path(
        "check_department_exist/",
        AdminViews.check_department_exist,
